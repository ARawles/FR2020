...
cc_data <- cc_data %>%
   dplyr::mutate(Date = as.Date(Date, format = "%d/%m/%Y"),
                 topic = case_when(
                    stringr::str_detect(Title, pattern = "Javascript|CSS|jQuery|React|Node.js|HTML") ~ "Web software",
                    stringr::str_detect(Title, pattern = "Mac|Windows|Linux") ~"Operating systems",
                    TRUE ~ "Other"
                 ))
head(cc_data, 10)
